      ...
      <g>
        {showCpuConnections && (
          <g fill="url(#cpu-connection-gradient)">
            ...
            <rect x="129.3" y="44" width="2.5" height="5" rx="0.7" transform="rotate(90 116.25 45.5)" />
            <rect x="135.8" y="44" width="2.5" height="5" rx="0.7" transform="rotate(90 116.25 45.5)" />
            ...
            <rect x="67" y="-13.6" width="2.5" height="5" rx="0.7" transform="rotate(270 115.25 19.5)" />
            <rect x="74" y="-13.6" width="2.5" height="5" rx="0.7" transform="rotate(270 115.25 19.5)" />
          </g>
        )}
        <rect x="70" y="38" width="65" height="24" rx="3" fill="#0a0a0a" filter="url(#cpu-light-shadow)" />
        <text x="78" y="53" fontSize="7" fill={animateText ? "url(#cpu-text-gradient)" : "white"} fontWeight="600" letterSpacing="0.05em">
          {text}
        </text>
      </g>
